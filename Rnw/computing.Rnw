...
\chapter{Hardware}
<<hardware,child='hardware.Rnw',eval=TRUE>>=
@

\chapter{The Operating System}
<<os,child='os.Rnw',eval=TRUE>>=
@

\chapter{C++ Programming}
<<cpp, child='c.Rnw',eval=TRUE>>=
@

\chapter{Java Programming}
<<java, child='java.Rnw',eval=TRUE>>=
@

\chapter{Python Programming}
<<python, child='python.Rnw',eval=TRUE>>=
@

\chapter{R Programming}
<<child='Rprog.Rnw',eval=TRUE>>=
@

\chapter{Programming Tools}
<<child='tools.Rnw',eval=TRUE>>=
@

\chapter{Data Visualization}
<<child='graphics.Rnw',eval=TRUE>>=
@

\chapter{Data Processing}
<<child='preprocessing.Rnw',eval=TRUE>>=
@
